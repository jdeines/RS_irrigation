...
*price not significantly correlated with area or volume

### Regressions

```{r regressions}
# area as a function of precip and price
precipPrice <- lm(Area_km2 ~ Precip + Price, data = rrca)
summary(precipPrice)

pumpPrecipPrice <- lm(Volume_km3 ~ Precip + Price, data = rrca)
summary(pumpPrecipPrice)
```
