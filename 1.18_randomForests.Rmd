...
g2007 <- read.csv(paste0(accuDir,
        '/2007_MidRep_confusionData_RRB_test3_randFor_uncleaned_monthAnnualCombo_allClasses.csv'))
g2010 <- read.csv(paste0(accuDir,
        '/2010_MidRep_confusionData_RRB_test3_randFor_uncleaned_monthAnnualCombo_allClasses.csv'))
