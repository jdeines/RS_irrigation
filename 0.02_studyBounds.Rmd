...
unionState$masterID <- c('Union_NE','Union_CO','Union_KS')
...
plot(rrbstates3[rrbstates3$STATE_ABBR == 'NE',], add=T, col = 'blue')
plot(rrca.rrb.states[rrca.rrb.states$STATE_ABBR == 'NE',], add=T, col='lightblue')
