...
```{r regionLatLong, fig.width = 8, fig.height = 5.5, dpi=600, dev=c('png','pdf')}
...
text1 = list("sp.text", c(-220000,1750000), "0", cex=1)
text2 = list("sp.text", c(-125000,1750000), "100 km",cex = 1)
