...
```{r freqMap_matlab2_bottom_matlab_lightgray, fig.width = 7, fig.height = 5, dpi=600, dev=c('png','pdf')}
...
```{r inset1_freqMap_matlab_lightgray, fig.width = 2.5, fig.height = 3.2, dpi=600, dev=c('png','pdf')}
