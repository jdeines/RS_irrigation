...
library(knitr)
opts_chunk$set(cache=TRUE, cache.path='cache/4.1_FreqFigs/test4/',
               fig.path='figure/4.1_FreqFigs_randFor/to2016/test4/')
```
...
```{r userVars}
# dirs and names
rasDir <- 'C:/Users/deinesji/Google Drive/GEE_classification/RRB_test4_randFor_interannualClean'
rasRaw <- 'IrrigationFrequencyMap_0and1neg.tif'
rasMasked <- 'IrrigationFrequencyMap_0and1neg_boundMask.tif'
  
# inset sets
rasSmall1.name <- 'IrrigationFrequencyMap_0and1neg_inset_1.tif'
earlyInset1.name <- 'earliestYearIrrigated_inset_1.tif'
lateInset1.name <- 'latestYearIrrigated_inset_1.tif'
...
# load extent 
extent <- readOGR(extentDir, extentName, verbose=F)
...
write.csv(yearCounts, paste0(rasDir,'/test4_randFor_yearMapCounts.csv'),
          row.names=F) 
```
...
# load yearmap counts
yearCounts <- read.csv(paste0(rasDir,'/test4_randFor_yearMapCounts.csv'))
# sort
...
```{r inset1_freqMap, fig.width = 2.5, fig.height = 3.2, dpi=96, cache=FALSE}
# load full raster
...
```{r inset2_freqMap, fig.width = 2.5, fig.height = 3.2, dpi=96, cache=FALSE}
# load full raster
...
```{r inset3_freqMap, fig.width = 2.5, fig.height = 3.2, dpi=96, cache=FALSE}
# load full raster
...
```{r inset2_early, fig.width = 2.5, fig.height = 3.2, dpi=96, cache=FALSE}
# load full raster
...
```{r inset3_early, fig.width = 2.5, fig.height = 3.2, dpi=96, cache=FALSE}
# load full raster
...
```{r inset2_late, fig.width = 2.5, fig.height = 3.2, dpi=96, cache=FALSE}
# load full raster
...
```{r inset3_late, fig.width = 2.5, fig.height = 3.2, dpi=96, cache=FALSE}
# load full raster
