...
```{r loadData, fig.width = 5.5, fig.height=4.5, cache=F}
...
plot(trainPoints[trainPoints$year == 2010,], col='#fd8d3c',add=T, cex=.75, pch=19, axes=F)
plot(trainPoints[trainPoints$year == 2012,], col='#cb181d',add=T, cex=.75, pch=19, axes=F)
