...
```{r loadData, fig.width = 3.25, fig.height=1.75}
...
par(mar=c(0,0,0,0))
plot(koep, col=c('seashell2','wheat','honeydew'))
plot(trainPoints[trainPoints$year == 2010,], col='#5e3c99',add=T, cex=.75, pch=19)
plot(trainPoints[trainPoints$year == 2012,], col='#e66101',add=T, cex=.75, pch=19)
```
...
```{r greenIndexPlotByCrop_manuscript_top, fig.width = 6.25, fig.height = 4, dev='png'}
# Greenness Index, 2010: Quartiles for talk 
dfagg <- aggregateIndexByCrop_quartiles(index = 'GI', year = 2010, df=trainAllLong)
#plotIndexByCrop_quartiles(dfPlot = dfagg, title = '2010 Greenness Index (GI)', index = 'Greenness')
