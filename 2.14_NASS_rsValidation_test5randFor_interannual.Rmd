...
```{r setFips}
fipsDir <- 'C:/Users/deinesji/Dropbox/1PhdJill/hpa/irrigation/data/GIS/kml/FINAL_BOUNDARIES'
fips <- read.csv(paste0(outDir,'/boundary_options_fips_for_contained_countyies.csv'),
                 colClasses = 'character')
fipsToUse0 <- fips$original
...
countyDir <- 'C:/Users/deinesji/Google Drive/GEE_tableExports/RRB_test5_regional_county_Stats'
