...
library(knitr)
opts_chunk$set(cache=TRUE, cache.path='cache/5.0_confusion/',
...
file2001 <- '2001_Wardlow_confusionData_RRB_test1.csv'
...
# load data
dataDir <- 'C:/Users/deinesji/Google Drive/GEE_tableExports/Accuracy_PointsforConfusionTables_test1_clean'
file2007 <- '2007_MidRep60_confusionData_RRB_test1_randomnesstest.csv'
...
# load data
dataDir <- 'C:/Users/deinesji/Google Drive/GEE_tableExports/Accuracy_PointsforConfusionTables_test1_clean'
file2010 <- '2010_MidRep20_confusionData_RRB_test1.csv'
