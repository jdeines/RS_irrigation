...
Any CDL class with 'DEVELOPED' in it is also removed from the sample.
...
sampleFactor <- 1.8 # increase sample points to offset grassland thinning
...
writeOGR(nrdPoints.ll, outdir, 'valid_MidRep_10_2010', driver='ESRI Shapefile', 
         overwrite = T)
writeOGR(nrdPoints.ll, paste0(outdir, '/valid_MidRep_10_2010.kml'),
            layer = 'thislayer', driver='KML', overwrite=F)

# write KML to my dropbox for laptop access
writeOGR(nrdPoints.ll, 'C:/Users/deinesji/Dropbox/1PhdJill/hpa/irrigation/data/GIS/kml/valid_MidRep_10_2010.kml', layer = 'thislayer', driver='KML', overwrite=F)
```
