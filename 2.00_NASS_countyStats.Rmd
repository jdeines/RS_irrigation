...
```{r fullRRB, fig.height=4, fig.width = 12}
# load TIGER counties ----------------------------------------------------------
countyAll <- readOGR('S:/Data/GIS_Data/Downloaded/TIGER/TIGER2012/COUNTY',
                     'tl_2012_us_county', verbose=F)
#polygon denoting area of interest
...
# clean/summarize data
rrb2012 <- cleanNassCensus(nass.df, year = 2012)
rrb2007 <- cleanNassCensus(nass.df, year = 2007)
#midRep2002 <- cleanNassCensus(nass.df, year = 2002)
...
# make a plot of irrigated crops
summary.wide2 <- rrb2012[rrb2012$IRRIGATED > 0,
                              c('commodity_desc','IRRIGATED', 'NON_IRR')]
...
```{r fullHPA, eval=FALSE, message=FALSE}
# load TIGER counties ----------------------------------------------------------
countyAll <- readOGR('S:/Data/GIS_Data/Downloaded/TIGER/TIGER2012/COUNTY',
                     'tl_2012_us_county', verbose=F)
#polygon denoting area of interest
...
# clean/summarize data
hpa2012 <- cleanNassCensus(nass.df, year = 2012)
hpa2007 <- cleanNassCensus(nass.df, year = 2007)
#midRep2002 <- cleanNassCensus(nass.df, year = 2002)
...
# make a plot of irrigated crops
summary.wide2 <- hpa2012[hpa2012$IRRIGATED > 1000,
                              c('commodity_desc','IRRIGATED', 'NON_IRR')]
...
# make a plot of irrigated crops
summary.wide2 <- hpa2007[hpa2007$IRRIGATED > 1000,
                              c('commodity_desc','IRRIGATED', 'NON_IRR')]
