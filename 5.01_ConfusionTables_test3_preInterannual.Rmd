...
but not interannual cleaning

```{r knitrOpts, echo=FALSE}
library(knitr)
opts_chunk$set(cache=FALSE, cache.path='cache/5.01_confusion/',
               fig.path='figure/5.01_confusion/')
```
...
file2001 <- '2001_Wardlow_confusionData_RRB_test3_cart.csv'
...
# load data
dataDir <- 'C:/Users/deinesji/Google Drive/GEE_tableExports/Accuracy_PointsforConfusionTables_test1_clean'
file2007 <- '2007_MidRep60_confusionData_RRB_test3_cart.csv'
...
# load data
dataDir <- 'C:/Users/deinesji/Google Drive/GEE_tableExports/Accuracy_PointsforConfusionTables_test1_clean'
file2010 <- '2010_MidRep60_confusionData_RRB_test3_cart.csv'
