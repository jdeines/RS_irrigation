...
```{r numerology}
stataData <- combined[grepl('full', combined$masterID),]

# by state, growth as a percentage of 1999 area
percentage <- stataData[stataData$dataset == 'total' &
              stataData$year == '2016', c('masterID','area_km2')]
percentage$startArea <- stataData[stataData$dataset == 'total' &
              stataData$year == '1999', 'area_km2']
