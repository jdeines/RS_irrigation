...
library(knitr)
opts_chunk$set(cache=FALSE, cache.path='cache/2.1_NASS_v/',
...
countyDir <- 'C:/Users/deinesji/Google Drive/GEE_tableExports/county_counts_RRB_test2_cleaned'

# get filenames
countyfiles <- list.files(countyDir, pattern="*cleaned.csv")
...
```{r multipanel, fig.width = 9.5, fig.height = 3.3}
allyears <- rbind(merged1997, merged2002, merged2007, merged2012)
